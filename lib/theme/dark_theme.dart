...
ThemeData dark = ThemeData(
  ...
  colorScheme: const ColorScheme.dark(
    ...
    tertiary: Color(0xff6165D7),  // Keep original tertiary color
    tertiaryContainer: Color(0xff171DB6),  // Keep original tertiary container color
    secondary: Color(0x9BD61A65), // Adjusted secondary color to match primary
